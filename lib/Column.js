...
var Column = function (_React$Component) {
    ...
    _createClass(Column, [{
        ...
        key: 'getHeightForColumnItemIndex',
        value: function getHeightForColumnItemIndex(index) {
            return this.getHeightForColumnItem(_reactDom2.default.findDOMNode(this.refs['column-item-' + index]));
        }
    }, {
        key: 'getHeightForColumnItem',
        value: function getHeightForColumnItem(columnItem) {
            var regExp = /^(\d+(\.\d+)?)px$/;
        ...
        value: function getBoundsForSeparator(index) {
            var heightA = this.getHeightForColumnItemIndex(index);
            var heightB = this.getHeightForColumnItemIndex(index + 1);
        ...
        value: function handlePositionChange(index, offset) {
            var widthA = this.getHeightForColumnItemIndex(index);
            var widthB = this.getHeightForColumnItemIndex(index + 1);
