...
var ColumnItem = function (_SplittablePanel) {
    _inherits(ColumnItem, _SplittablePanel);

    function ColumnItem() {
        _classCallCheck(this, ColumnItem);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(ColumnItem).apply(this, arguments));
    }
    ...
    _createClass(ColumnItem, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                _extends({ ref: 'container', className: (0, _classnames2.default)(theme['floaty-column-item'], className) }, other),
