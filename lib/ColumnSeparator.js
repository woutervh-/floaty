...
var ColumnSeparator = function (_React$Component) {
    ...
    function ColumnSeparator() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ColumnSeparator)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
            offset: 0
    ...
    _createClass(ColumnSeparator, [{
        ...
        value: function handleDrag(event) {
            this.setState({ offset: this.clampOffset(event.y) });
        }
    }, {
        key: 'handleDragStop',
