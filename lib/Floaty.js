...
var Floaty = function (_SplittablePanel) {
    ...
    _createClass(Floaty, [{
        ...
        value: function render() {
            ...
            var refs = _props2.refs;
            var stackControls = _props2.stackControls;
            var theme = _props2.theme;
            var isFloating = _props2.isFloating;
            var floatingItem = _props2.floatingItem;
            var floatingTitle = _props2.floatingTitle;

            var other = _objectWithoutProperties(_props2, ['children', 'layout', 'dispatch', 'id', 'item', 'refs', 'stackControls', 'theme', 'isFloating', 'floatingItem', 'floatingTitle']);
