...
var Floaty = function (_SplittablePanel) {
    ...
    _createClass(Floaty, [{
        ...
        value: function renderLeafComponent(leafObject, _dispatch2, refAccumulator) {
            var _this4 = this;
            ...
            if (leafObject.state && _react2.default.isValidElement(result)) {
                var _ret3 = function () {
                    var _props$reducer = _this4.props.reducer;
                    var reducer = _props$reducer === undefined ? identity : _props$reducer;

                    return {
                        v: _react2.default.cloneElement(result, _extends({ dispatch: function dispatch(update) {
                                return _dispatch2((0, _actions.setStateFromReducer)(reducer, update));
                            } }, leafObject.state))
                    };
                }();
                ...
                var _ret4 = function () {
                    var _props$reducer2 = _this4.props.reducer;
                    var reducer = _props$reducer2 === undefined ? identity : _props$reducer2;

                    return {
                        v: result(_extends({ dispatch: function dispatch(update) {
                                return _dispatch2((0, _actions.setStateFromReducer)(reducer, update));
                            } }, leafObject.state))
                    };
                }();
        ...
        value: function renderColumn(dispatch, refAccumulator, columnObject) {
            ...
            return _react2.default.createElement(
                ...
                columnObject.items.map(function (columnItemObject, index) {
                    return _this5.renderColumnItem(function (update) {
        ...
        value: function renderRow(dispatch, refAccumulator, rowObject) {
            ...
            return _react2.default.createElement(
                ...
                rowObject.items.map(function (rowItemObject, index) {
                    return _this6.renderRowItem(function (update) {
        ...
        value: function renderStack(dispatch, refAccumulator, stackObject) {
            ...
            var props = _extends({
                ...
                titles: stackObject.titles.map(function (tabTitle) {
                    return _this7.renderLeafComponent(tabTitle);
                }) || [],
            ...
            return _react2.default.createElement(
                ...
                stackObject.items.map(function (stackItemObject, index) {
                    return _this7.renderStackItem(function (update) {
        ...
        value: function render() {
            ...
            var reducer = _props.reducer;
            var refs = _props.refs;
            var stackControls = _props.stackControls;
            var theme = _props.theme;

            var other = _objectWithoutProperties(_props, ['children', 'dispatch', 'layout', 'reducer', 'refs', 'stackControls', 'theme']);
