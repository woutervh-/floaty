    ...
    _createClass(Floaty, [{
        ...
        value: function renderStack(dispatch, refAccumulator, stackObject) {
            ...
            var props = _extends({
                ...
                titles: stackObject.titles.map(function (tabTitle) {
                    return _this6.renderTabTitle(tabTitle);
                }) || [],
        ...
        value: function renderFloatingStack() {
            ...
            return _react2.default.createElement(
                ...
                { title: this.renderTabTitle(title), x: x, y: y },
        ...
        value: function render() {
            ...
            var other = _objectWithoutProperties(_props, ['children', 'dispatch', 'layout', 'refs', 'theme']);
