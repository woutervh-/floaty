        ...
        value: function resolveDropArea(position) {
            ...
            if (this.item) {
                ...
                var _ret2 = function () {
                    ...
                    var id = _props3.id;
                    var item = _props3.floatingItem;
                    var title = _props3.floatingTitle;
...
exports.default = (0, _connect2.default)(_selectors.floatySelector, undefined, undefined, { withRef: true })(Floaty);