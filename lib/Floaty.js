    ...
    _createClass(Floaty, [{
        ...
        value: function renderStack(dispatch, refAccumulator, stackObject) {
            ...
            var props = _extends({
                ...
                titles: stackObject.titles.map(function (tabItem) {
                    return _this5.renderTabItem(tabItem);
                }) || [],
        ...
        key: 'renderTabItem',
        value: function renderTabItem(tabObject) {
        ...
        value: function renderFloatingStack() {
            ...
            return _react2.default.createElement(
                ...
                { title: title, x: this.state.x, y: this.state.y },
