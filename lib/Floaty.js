...
var Floaty = function (_React$Component) {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Floaty.__proto__ || Object.getPrototypeOf(Floaty)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            if (isFloating) {
                ...
                if (resolution.resolved) {
                    ...
                    var _floatingItem = _this$props3.floatingItem;
                    var _floatingTitle = _this$props3.floatingTitle;
                    var floaty = _this$props3.floaty;
                    var onClose = _this$props3.onClose;

                    if (onClose) {
                        onClose(floaty.items[_floatingItem] || _floatingItem, floaty.items[_floatingTitle] || _floatingTitle);
                    }
                }
            }
        }, _this.dragStart = function (item, title) {
            var _this$props4 = _this.props;
            var dispatch = _this$props4.dispatch;
            var id = _this$props4.id;
            var theme = _this$props4.theme;
    ...
    _createClass(Floaty, [{
        ...
        value: function render() {
            ...
            var other = _objectWithoutProperties(_props4, ['children', 'layout', 'dispatch', 'id', 'item', 'refs', 'floaty', 'stackControls', 'theme', 'isFloating', 'floatingItem', 'floatingTitle', 'onClose']);
...
exports.default = (0, _connect2.default)(_selectors.floatySelector, undefined, undefined, { pure: false })(Floaty);