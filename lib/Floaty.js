...
var Floaty = function (_SplittablePanel) {
    ...
    _createClass(Floaty, [{
        ...
        value: function renderFloatingStack() {
            ...
            var item = _props.floatingItem;
            var title = _props.floatingTitle;
        ...
        value: function render() {
            ...
            var refs = _props3.refs;
            var stackControls = _props3.stackControls;
            var theme = _props3.theme;
            var isFloating = _props3.isFloating;
            var floatingItem = _props3.floatingItem;
            var floatingTitle = _props3.floatingTitle;

            var other = _objectWithoutProperties(_props3, ['children', 'layout', 'dispatch', 'id', 'item', 'refs', 'stackControls', 'theme', 'isFloating', 'floatingItem', 'floatingTitle']);
            ...
            return _react2.default.createElement(
                ...
                (0, _references.isReference)(item) ? _react2.default.createElement(_Item2.default, { ref: function ref(r) {
