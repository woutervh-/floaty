    ...
    _createClass(GenericContent, [{
        ...
        value: function split(position) {
            ...
            if (_DomUtil2.default.isWithinBox(position, rightBox)) {
                return _extends({}, box, { x: box.x + box.width / 2, width: box.width / 2, dispatch: _actions.noOperation, resolved: true });
            }
            if (_DomUtil2.default.isWithinBox(position, topBox)) {
                return _extends({}, box, { height: box.height / 2, dispatch: _actions.noOperation, resolved: true });
            }
            if (_DomUtil2.default.isWithinBox(position, bottomBox)) {
                return _extends({}, box, { y: box.y + box.height / 2, height: box.height / 2, dispatch: _actions.noOperation, resolved: true });
            }
