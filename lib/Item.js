...
var Item = function (_React$Component) {
    ...
    _createClass(Item, [{
        ...
        value: function renderLeafComponent() {
            ...
            var other = _objectWithoutProperties(_props2, ['type', 'state', 'name', 'content']);
            ...
            if (_react2.default.isValidElement(result)) {
                return _react2.default.cloneElement(result, _extends({}, other, state));
            } else if (typeof result === 'function') {
                return result(_extends({}, other, state));
            } else {
                return result;
            }
        }
