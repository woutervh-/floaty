...
export default class Row extends React.Component {
    ...
    renderRowItems() {
        ...
        for (let i = 0; i < items.length; i++) {
            if (i > 0) {
                result.push(React.createElement(RowSeparator, { key: 2 * i - 1, getBounds: () => this.getBoundsForSeparator(i - 1), onPositionChange: offset => this.handlePositionChange(i - 1, offset) }));
            }
            const growValue = (growValues[i] || 1) / growValuesSum;
            const element = React.createElement(RowItem, { key: 2 * i, ref: (r) => {
                    if (r === null) {
    ...
    render() {
        ...
        return React.createElement("div", Object.assign({ className: classNames(theme['floaty-row'], className) }, other), this.renderRowItems());
    }
}
Row.contextTypes = {
