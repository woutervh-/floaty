...
var Row = function (_React$Component) {
    ...
    _createClass(Row, [{
        ...
        value: function getWidthForRowItem(index) {
            var regExp = /^(\d+(\.\d+)?)px$/;
            var rowItem = _reactDom2.default.findDOMNode(this.refs['row-item-' + index]);
        ...
        value: function renderRowItems(children) {
            ...
            for (var _i = 0; _i < rows.length; _i++) {
                if (_i > 0) {
                    result.push(_react2.default.createElement(_RowSeparator2.default, { getBounds: this.getBoundsForSeparator.bind(this, _i - 1), onPositionChange: this.handlePositionChange.bind(this, _i - 1) }));
                }
                var rowItem = rows[_i];
                var growValue = growValues[_i] / growValuesSum;
                var style = 'props' in rowItem && 'style' in rowItem.props && rowItem.props.style || {};
                var element = _react2.default.cloneElement(rowItem, { ref: 'row-item-' + _i, style: _extends({}, style, { flexGrow: growValue }) });
                result.push(element);
            }
            return result;
        }
        ...
        value: function resolveDropArea(position) {
            for (var i = 0; i < _react2.default.Children.count(this.props.children); i++) {
                var element = _reactDom2.default.findDOMNode(this.refs['row-item-' + i]);
