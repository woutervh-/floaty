...
var RowItem = /** @class */ (function (_super) {
    ...
    RowItem.prototype.shouldComponentUpdate = function (nextProps, _, nextContext) {
        return !shallowEqual(this.props, nextProps) || !shallowEqual(this.context, nextContext);
    };
    RowItem.prototype.resolveDropArea = function (position) {
    ...
    RowItem.prototype.render = function () {
        ...
        return React.createElement("div", __assign({ className: classNames(theme['floaty-row-item'], className) }, other),
