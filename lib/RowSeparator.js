...
class RowSeparator extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            offset: 0
    ...
    render() {
        ...
        const { floatyContext: { theme } } = this.context;
        return React.createElement("div", { className: classnames_1.default(theme['floaty-row-separator'], className), style: { left: offset } });
    }
}
