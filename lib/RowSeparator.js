...
var RowSeparator = function (_React$Component) {
    _inherits(RowSeparator, _React$Component);
    ...
    function RowSeparator() {
        ...
        _classCallCheck(this, RowSeparator);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RowSeparator)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
            offset: 0
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(RowSeparator, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('div', { className: (0, _classnames2.default)(theme['floaty-row-separator'], className), style: { left: offset } });
        }
    }]);
