...
var SplittablePanel = function (_React$Component) {
    ...
    function SplittablePanel() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(SplittablePanel).apply(this, arguments));
    }
    ...
    _createClass(SplittablePanel, [{
        ...
        value: function split(position) {
            ...
            if (_DomUtil2.default.isWithinBox(position, leftBox)) {
                ...
                return _extends({}, box, { width: box.width / 2, dispatch: function dispatch(item, name) {
                        return _this2.dispatch((0, _actions.transformIntoRow)([{ type: 'stack', names: [name], items: [item] }], true));
                    }, resolved: true });
            }
            if (_DomUtil2.default.isWithinBox(position, rightBox)) {
                ...
                return _extends({}, box, { x: box.x + box.width / 2, width: box.width / 2, dispatch: function dispatch(item, name) {
                        return _this2.dispatch((0, _actions.transformIntoRow)([{ type: 'stack', names: [name], items: [item] }], false));
                    }, resolved: true });
            }
            if (_DomUtil2.default.isWithinBox(position, topBox)) {
                return _extends({}, box, { height: box.height / 2, dispatch: function dispatch(item, name) {
                        return _this2.dispatch((0, _actions.transformIntoColumn)([{ type: 'stack', names: [name], items: [item] }], true));
                    }, resolved: true });
            }
            if (_DomUtil2.default.isWithinBox(position, bottomBox)) {
                return _extends({}, box, { y: box.y + box.height / 2, height: box.height / 2, dispatch: function dispatch(item, name) {
                        return _this2.dispatch((0, _actions.transformIntoColumn)([{ type: 'stack', names: [name], items: [item] }], false));
                    }, resolved: true });
            }
