...
var Stack = function (_SplittablePanel) {
    ...
    _createClass(Stack, [{
        ...
        key: 'renderHeaderTab',
        value: function renderHeaderTab(index) {
            ...
            return _react2.default.createElement(
                'li',
                { ref: 'tab-' + index, className: (0, _classnames2.default)(theme['floaty-stack-header-tabs-item'], _defineProperty({}, theme['floaty-stack-header-tabs-item-active'], index == active)), onClick: this.handleTabClick.bind(this, index) },
                titles[index]
            );
        }
    }, {
        ...
        value: function renderHeaderTabs() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.Children.map(children, function (child, index) {
                    return _this4.renderHeaderTab(index);
                })
            );
        }
    }, {
        ...
        value: function renderHeader() {
            ...
            var beforeTabs = _props4.beforeTabs;
            var afterTabs = _props4.afterTabs;
            var theme = this.context.theme;
        ...
        value: function render() {
            ...
            var afterTabs = _props5.afterTabs;
            var beforeTabs = _props5.beforeTabs;
            ...
            var other = _objectWithoutProperties(_props5, ['active', 'afterTabs', 'beforeTabs', 'children', 'className', 'dispatch', 'float', 'titles']);
...
Stack.propTypes = {
    ...
    beforeTabs: _react2.default.PropTypes.any,
    afterTabs: _react2.default.PropTypes.any
};
Stack.contextTypes = {
