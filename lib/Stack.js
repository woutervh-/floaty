...
var Stack = function (_React$Component) {
    ...
    _createClass(Stack, [{
            ...
            return _react2.default.createElement(
                ...
                titles.map(function (title, index) {
                    return _react2.default.createElement(
                        ...
                        (0, _identifiers.isIdentifier)(title) ? _react2.default.createElement(_Item2.default, { id: title, floatyStackId: id, floatyStackIndex: index }) : title
                    );
                })
            );
        }
        ...
        value: function render() {
            ...
            var other = _objectWithoutProperties(_props6, ['active', 'items', 'className', 'id', 'dispatch', 'float', 'titles', 'type']);
