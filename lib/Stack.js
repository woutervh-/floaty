...
var Stack = function (_React$Component) {
    ...
    _createClass(Stack, [{
        ...
        value: function resolveDropArea(position) {
            ...
            if (DomUtil.isWithinBox(position, headerBox)) {
                ...
                if (DomUtil.isWithinBox(position, containerBox)) {
                    ...
                    var _dispatch = _props3.dispatch;
                    var _id = _props3.id;
        ...
        value: function render() {
            ...
            var float = _props6.float;
            var titles = _props6.titles;

            var other = _objectWithoutProperties(_props6, ['active', 'items', 'className', 'controls', 'dispatch', 'float', 'titles']);
            ...
            return _react2.default.createElement(
                ...
                this.renderHeader(),
                _react2.default.createElement(_StackItem2.default, { value: items[active] })
            );
        }
    }]);
