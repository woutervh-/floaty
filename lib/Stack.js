...
var Stack = function (_SplittablePanel) {
    ...
    function Stack() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Stack.__proto__ || Object.getPrototypeOf(Stack)).call.apply(_ref, [this].concat(args))), _this), _this.unmakeDraggablesImmediate = null, _this.draggables = [], _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(Stack, [{
        ...
        value: function resolveDropArea(position) {
            ...
            if (_DomUtil2.default.isWithinBox(position, headerBox)) {
                var _ret3 = function () {
                    ...
                    var _dispatch = _props2.dispatch;

                    var _loop = function _loop(i) {
                        var tabElement = _reactDom2.default.findDOMNode(_this3.refs['tab-' + i]);
                        var tabBox = _DomUtil2.default.elementOffset(tabElement);
                        if (_DomUtil2.default.isWithinBox(position, tabBox)) {
                            return {
                                v: {
                                    v: _extends({}, tabBox, { dispatch: function dispatch(item, name) {
                                            return _dispatch((0, _actions.insertTab)(i, item, name));
                                        }, resolved: true })
                                }
                            };
                        }
                    ...
                    for (var i = 0; i < _react2.default.Children.count(children); i++) {
                        var _ret4 = _loop(i);
        ...
        value: function renderTabs() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.Children.map(children, function (child, index) {
                    return _react2.default.createElement(
                        'li',
                        { key: index, ref: 'tab-' + index, className: (0, _classnames2.default)(theme['floaty-stack-header-tabs-item'], _defineProperty({}, theme['floaty-stack-header-tabs-item-active'], index === active)), onClick: _this4.handleTabClick.bind(_this4, index) },
                        titles[index]
                    );
                })
            );
        ...
        value: function render() {
            ...
            var controls = _props5.controls;
            var dispatch = _props5.dispatch;
            var float = _props5.float;
            var titles = _props5.titles;

            var other = _objectWithoutProperties(_props5, ['active', 'children', 'className', 'controls', 'dispatch', 'float', 'titles']);
