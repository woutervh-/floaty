        ...
        case _constants.FLOATY_TRANSFORM_INTO_ROW:
            {
                ...
                var _ref = [(0, _identifiers.generateIdentifier)(), (0, _identifiers.generateIdentifier)()];
                var id1 = _ref[0];
                var id2 = _ref[1];
...
function floaty() {
    ...
    var _ret = function () {
        switch (action.type) {
            ...
            case _constants.FLOATY_START_FLOATING:
            case _constants.FLOATY_STOP_FLOATING:
            case _constants.FLOATY_SWEEP:
            case _constants.FLOATY_ADD_ITEM:
                if (action.type === _constants.FLOATY_SET_LAYOUT) {
                    action.itemId = (0, _identifiers.generateIdentifier)();
                }
                ...
                if (action.type === _constants.FLOATY_SWEEP) {
