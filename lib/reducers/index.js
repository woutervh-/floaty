...
function floaty() {
    ...
    var _ret = function () {
        switch (action.type) {
            ...
            case _constants.FLOATY_START_FLOATING:
            case _constants.FLOATY_STOP_FLOATING:
                if (action.type === _constants.FLOATY_SET_LAYOUT) {
                    action.itemId = (0, _references.generateIdentifier)();
                }
                ...
                var next = _extends({}, state, {
                    entities: _extends({}, entities, {
                        floatyItems: _extends({}, floatyItems(items, action)),
                        floatyLayouts: _extends({}, floatyLayouts(layouts, action))
                    })
                });
                var minimized = {};
                Object.keys(next.entities.floatyLayouts).forEach(function (key) {
                    var layout = next.entities.floatyLayouts[key];
                ...
                if (action.type === _constants.FLOATY_STOP_FLOATING) {
